// Sync the curated, user-facing pages from ../docs into ./docs/{guides,architecture,concepts}
// for VitePress.
//
// Single source of truth stays <repo>/docs/. Publication is an explicit ALLOWLIST
// (see guides.mjs) — internal dev docs (development guide, review, issue notes,
// working documents) are deliberately NOT published. Cross-links inside published
// pages that point at a NON-published doc are rewritten to the GitHub blob URL so
// they keep working instead of 404-ing on the site.
...
const blobBase = `https://github.com/eclipse-fennec/emf.persistence-jpa/blob/${branch}/docs`;

const sections = [
  { items: GUIDES, dir: 'guides' },
  { items: ARCHITECTURE, dir: 'architecture' },
  { items: CONCEPTS, dir: 'concepts' },
];
