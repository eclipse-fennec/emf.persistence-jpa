...
/**
 * Validate-then-translate helper for the Mongo resource. Lives outside the resource
 * class because {@code Resource.Diagnostic} (inherited into every resource body) shadows
...
public final class MongoQueries {
	 ...
	 *
	 * @param processor the mongo query processor
	 ...
	 */
	public static MongoQueryPlan translate(QueryProcessor processor, Query query, EClass rootEClass,
		...
		return (MongoQueryPlan) processor.translate(query,
