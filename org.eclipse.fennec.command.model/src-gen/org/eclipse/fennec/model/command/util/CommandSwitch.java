 ...
 */
package org.eclipse.fennec.model.command.util;
 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.fennec.model.command.CommandPackage
 * @generated
 */
public class CommandSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CommandPackage.INSERT_COMMAND: {
				InsertCommand insertCommand = (InsertCommand)theEObject;
				T result = caseInsertCommand(insertCommand);
				if (result == null) result = caseCommand(insertCommand);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CommandPackage.DELETE_COMMAND: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Insert Command</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Insert Command</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseInsertCommand(InsertCommand object) {
		return null;
	}
