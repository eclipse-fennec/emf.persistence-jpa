 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.fennec.model2.query.QueryPackage#getAggregateMethod()
 * @model
 * @generated
 */
@ProviderType
public enum AggregateMethod implements Enumerator {
	 ...
	 * @ordered
	 */
	COUNT_DISTINCT(5, "COUNT_DISTINCT", "COUNT_DISTINCT");
	 ...
	 * @ordered
	 */
	public static final int COUNT_DISTINCT_VALUE = 5;
