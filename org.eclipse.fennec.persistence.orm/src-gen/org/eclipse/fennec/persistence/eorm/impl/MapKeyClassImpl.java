 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.persistence.eorm.impl.MapKeyClassImpl#getClass_ <em>Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MapKeyClassImpl extends MinimalEObjectImpl.Container implements MapKeyClass {
	...
	protected EClass eStaticClass() {
		return EORMPackage.eINSTANCE.getMapKeyClass();
	}
		...
		if (class_ != null && class_.eIsProxy()) {
			...
			if (class_ != oldClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EORMPackage.MAP_KEY_CLASS__CLASS, oldClass, class_));
			}
		}
		return class_;
	}
	...
	public void setClass(EClass newClass) {
		...
		class_ = newClass;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EORMPackage.MAP_KEY_CLASS__CLASS, oldClass, class_));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EORMPackage.MAP_KEY_CLASS__CLASS:
