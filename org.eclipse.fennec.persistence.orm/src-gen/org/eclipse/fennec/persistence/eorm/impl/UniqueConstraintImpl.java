 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.persistence.eorm.impl.UniqueConstraintImpl#getColumnName <em>Column Name</em>}</li>
 *   <li>{@link org.eclipse.fennec.persistence.eorm.impl.UniqueConstraintImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UniqueConstraintImpl extends MinimalEObjectImpl.Container implements UniqueConstraint {
	...
	protected EClass eStaticClass() {
		return EORMPackage.eINSTANCE.getUniqueConstraint();
	}
	...
	public EList<String> getColumnName() {
		if (columnName == null) {
			columnName = new EDataTypeEList<String>(String.class, this, EORMPackage.UNIQUE_CONSTRAINT__COLUMN_NAME);
		}
		return columnName;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EORMPackage.UNIQUE_CONSTRAINT__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EORMPackage.UNIQUE_CONSTRAINT__COLUMN_NAME:
				return getColumnName();
			case EORMPackage.UNIQUE_CONSTRAINT__NAME:
				return getName();
		}
