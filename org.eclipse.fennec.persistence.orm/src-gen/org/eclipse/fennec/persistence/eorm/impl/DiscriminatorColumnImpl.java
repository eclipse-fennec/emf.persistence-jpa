 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.persistence.eorm.impl.DiscriminatorColumnImpl#getColumnDefinition <em>Column Definition</em>}</li>
 *   <li>{@link org.eclipse.fennec.persistence.eorm.impl.DiscriminatorColumnImpl#getDiscriminatorType <em>Discriminator Type</em>}</li>
 *   <li>{@link org.eclipse.fennec.persistence.eorm.impl.DiscriminatorColumnImpl#getLength <em>Length</em>}</li>
 *   <li>{@link org.eclipse.fennec.persistence.eorm.impl.DiscriminatorColumnImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DiscriminatorColumnImpl extends MinimalEObjectImpl.Container implements DiscriminatorColumn {
	...
	protected EClass eStaticClass() {
		return EORMPackage.eINSTANCE.getDiscriminatorColumn();
	}
	...
	public void setColumnDefinition(String newColumnDefinition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EORMPackage.DISCRIMINATOR_COLUMN__COLUMN_DEFINITION, oldColumnDefinition, columnDefinition));
	}
	...
	public void setDiscriminatorType(DiscriminatorType newDiscriminatorType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EORMPackage.DISCRIMINATOR_COLUMN__DISCRIMINATOR_TYPE, oldDiscriminatorType, discriminatorType, !oldDiscriminatorTypeESet));
	}
	...
	public void unsetDiscriminatorType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EORMPackage.DISCRIMINATOR_COLUMN__DISCRIMINATOR_TYPE, oldDiscriminatorType, DISCRIMINATOR_TYPE_EDEFAULT, oldDiscriminatorTypeESet));
	}
	...
	public void setLength(int newLength) {
		...
		lengthESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EORMPackage.DISCRIMINATOR_COLUMN__LENGTH, oldLength, length, !oldLengthESet));
	}
	...
	public void unsetLength() {
		...
		lengthESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EORMPackage.DISCRIMINATOR_COLUMN__LENGTH, oldLength, LENGTH_EDEFAULT, oldLengthESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EORMPackage.DISCRIMINATOR_COLUMN__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EORMPackage.DISCRIMINATOR_COLUMN__COLUMN_DEFINITION:
				return getColumnDefinition();
			case EORMPackage.DISCRIMINATOR_COLUMN__DISCRIMINATOR_TYPE:
				return getDiscriminatorType();
			case EORMPackage.DISCRIMINATOR_COLUMN__LENGTH:
				return getLength();
			case EORMPackage.DISCRIMINATOR_COLUMN__NAME:
				return getName();
		}
