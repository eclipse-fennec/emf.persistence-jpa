 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.persistence.eorm.impl.EmbeddedImpl#getAttributeOverride <em>Attribute Override</em>}</li>
 *   <li>{@link org.eclipse.fennec.persistence.eorm.impl.EmbeddedImpl#getAssociationOverride <em>Association Override</em>}</li>
 *   <li>{@link org.eclipse.fennec.persistence.eorm.impl.EmbeddedImpl#getConvert <em>Convert</em>}</li>
 *   <li>{@link org.eclipse.fennec.persistence.eorm.impl.EmbeddedImpl#getAccess <em>Access</em>}</li>
 *   <li>{@link org.eclipse.fennec.persistence.eorm.impl.EmbeddedImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EmbeddedImpl extends MinimalEObjectImpl.Container implements Embedded {
	...
	protected EClass eStaticClass() {
		return EORMPackage.eINSTANCE.getEmbedded();
	}
	...
	public EList<AttributeOverride> getAttributeOverride() {
		if (attributeOverride == null) {
			attributeOverride = new EObjectContainmentEList<AttributeOverride>(AttributeOverride.class, this, EORMPackage.EMBEDDED__ATTRIBUTE_OVERRIDE);
		}
	...
	public EList<AssociationOverride> getAssociationOverride() {
		if (associationOverride == null) {
			associationOverride = new EObjectContainmentEList<AssociationOverride>(AssociationOverride.class, this, EORMPackage.EMBEDDED__ASSOCIATION_OVERRIDE);
		}
	...
	public EList<Convert> getConvert() {
		if (convert == null) {
			convert = new EObjectContainmentEList<Convert>(Convert.class, this, EORMPackage.EMBEDDED__CONVERT);
		}
		return convert;
	}
	...
	public void setAccess(AccessType newAccess) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EORMPackage.EMBEDDED__ACCESS, oldAccess, access, !oldAccessESet));
	}
	...
	public void unsetAccess() {
		...
		accessESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EORMPackage.EMBEDDED__ACCESS, oldAccess, ACCESS_EDEFAULT, oldAccessESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EORMPackage.EMBEDDED__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EORMPackage.EMBEDDED__CONVERT:
				return getConvert();
			case EORMPackage.EMBEDDED__ACCESS:
				return getAccess();
			case EORMPackage.EMBEDDED__NAME:
				return getName();
		}
