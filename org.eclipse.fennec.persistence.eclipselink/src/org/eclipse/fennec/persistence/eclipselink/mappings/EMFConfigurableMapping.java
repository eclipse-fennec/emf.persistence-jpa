 ...
 * {@link #configureEMF(EReference, EDynamicType, EDynamicTypeContext)}.
 *
...
public interface EMFConfigurableMapping {
	 ...
	 */
	default void configureEMF(EReference reference, EDynamicType type, EDynamicTypeContext context) {
		EMappingSupport.configureEMF((ForeignReferenceMapping) this, reference, type, context);
	}
}
