...
/**
 * {@link OneToOneMapping} variant that is aware of EMF lazy proxies (AP-46).
 * <p>
 ...
 * The foreign key itself is still written from the proxy's id.
 *
 * @author Mark Hoffmann
 * @since 15.07.2026
 */
public class EOneToOneMapping extends OneToOneMapping implements EMFConfigurableMapping {

	/** serialVersionUID */
	private static final long serialVersionUID = 7690998639818387180L;
