 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.fennec.model.expression.impl.ParameterRefImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterRefImpl extends ExpressionImpl implements ParameterRef {
	...
	protected EClass eStaticClass() {
		return ExpressionPackage.Literals.PARAMETER_REF;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionPackage.PARAMETER_REF__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExpressionPackage.PARAMETER_REF__NAME:
				return getName();
		}
